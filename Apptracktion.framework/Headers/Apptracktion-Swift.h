...
SWIFT_MODULE_NAMESPACE_PUSH("Apptracktion")
@class UIViewController;

SWIFT_CLASS("_TtC12Apptracktion12Apptracktion")
@interface Apptracktion : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) Apptracktion * _Nonnull tracker;)
+ (Apptracktion * _Nonnull)tracker SWIFT_WARN_UNUSED_RESULT;
+ (void)setTracker:(Apptracktion * _Nonnull)value;
@property (nonatomic) BOOL debug;
- (void)initWithOptions:(NSString * _Nonnull)appKey SWIFT_METHOD_FAMILY(none);
- (void)initWithOptions:(NSString * _Nonnull)appKey :(BOOL)debug SWIFT_METHOD_FAMILY(none);
- (void)startScreen:(UIViewController * _Nonnull)controller :(NSString * _Nonnull)screenName;
- (void)stopScreen:(UIViewController * _Nonnull)controller;
- (void)trackEventWithCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action label:(NSString * _Nonnull)label;
...
SWIFT_CLASS("_TtC12Apptracktion11ResultModel")
@interface ResultModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (NSString * _Nonnull)getMessage SWIFT_WARN_UNUSED_RESULT;
- (BOOL)getStatus SWIFT_WARN_UNUSED_RESULT;
- (void)setResultMessage:(NSString * _Nonnull)msg;
@end
...
SWIFT_CLASS("_TtC12Apptracktion15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(Apptracktion)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Apptracktion)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Apptracktion)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Apptracktion)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Apptracktion)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC12Apptracktion12TaskDelegate")
...
@interface UIDevice (SWIFT_EXTENSION(Apptracktion))
